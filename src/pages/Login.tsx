...
import { Zap, Sparkles, Mail, Lock, Eye, EyeOff, ArrowRight, Loader2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-muted-foreground mb-8">
            Log in to access your transcripts and continue where you left off.
          </p>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 items-center justify-center p-12 relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-20 right-20 w-96 h-96 bg-secondary/30 rounded-full blur-[120px]" />
        </div>
        ...
        <div className="relative text-center max-w-md">
          ...
          <h2 className="font-heading text-3xl font-bold mb-4">
            Transcribe in 60 Seconds
          </h2>
          <p className="text-muted-foreground text-lg">
            Join 10,000+ creators who save hours every week with AI-powered transcription.
          </p>
          ...
          <div className="mt-8 grid grid-cols-3 gap-4">
            {[
              ...
              <div key={index} className="p-4 bg-card/50 backdrop-blur rounded-xl">
